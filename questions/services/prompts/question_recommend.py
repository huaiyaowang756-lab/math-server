...
2. 综合考虑 description、questionBodyExcerpt（题干摘要）、knowledgePoints、questionTypes（题型节点）、features，判断题目是否涉及用户要排除或要求的内容。
3. 题干摘要、题型节点和特征中若含有用户需求关键词，应优先排在前面；若明确涉及用户要排除的内容，不得入选。
